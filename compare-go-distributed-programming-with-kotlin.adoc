...
----
include::./go-examples/goroutines.go[lines=13..30]
----
...
----
include::./kotlin-examples/src/main/kotlin/coroutines.kt[lines=9..31]
----
...
----
include::./kotlin-examples/src/main/kotlin/socket-server.kt[lines=13..33;40..67]
----
...
----
include::./kotlin-examples/src/main/kotlin/socket-client.kt[lines=19..52]
----
